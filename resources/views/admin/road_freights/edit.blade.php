...
@section('content')
    ...
    {!! Form::model($road_freight, ['method' => 'PUT', 'route' => ['admin.road_freights.update', $road_freight->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group pull-right">
                    ...
                    {!! Form::text('road_freight_number', old('road_freight_number'), ['class' => 'form-control', 'placeholder' => 'Auto Generated', 'readonly']) !!}
            ...
            <div class="row">
                <div class="col-xs-2 form-group">
                    ...
                    {!! Form::select('freight_contract_type', $enum_freight_contract_type, old('freight_contract_type'), ['class' => 'form-control select2', 'required' => '']) !!}
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="col-xs-8">
                                ...
                                {!! Form::select('vendor_drivers[]', $vendor_drivers, old('vendor_drivers'), ['class' => 'form-control select2 vendor-drivers_id', 'multiple' => 'multiple', 'id' => 'selectall-vendor_drivers' ]) !!}
                                ...
                                {!! Form::select('vendor_vehicles[]', $vendor_vehicles, old('vendor_vehicles'), ['class' => 'form-control select2 vendor-vehicles_id', 'multiple' => 'multiple', 'id' => 'selectall-vendor_vehicles' ]) !!}
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-striped" id="tab_logic">
                        ...
                        <tbody id="non-machine-costs">
                            @forelse(old('non_machine_costs', []) as $index => $data)
...
@section('javascript')
    ...
    <script type="text/html" id="load-descriptions-template">
        @include('admin.road_freights.load_descriptions_row',
                [
                    'index' => '_INDEX_',
                ])
               </script > 
