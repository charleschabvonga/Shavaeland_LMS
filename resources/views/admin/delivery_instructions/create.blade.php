...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.delivery_instructions.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group pull-right">
                    ...
                    <td class="text-center"><input type="text" name='delivery_instruction_number' value='{{ $delivery_instruction_number }}' class="form-control" readonly required/></td>
...
@section('javascript')
   ...
   <script src="/adminlte/js/mapInput.js"></script>
    ...
    <script>
        ...
        var nameTextField = document.getElementById("delivery_company_name");
    </script>
