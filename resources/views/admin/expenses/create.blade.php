        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group">
                    ...
                    {!! Form::text('entry_date', old('entry_date'), ['class' => 'form-control date', 'placeholder' => 'YYYYY-MM-DD', 'required' => '']) !!}
                ...
                <div class="col-xs-2 form-group pull-right">
                    ...
                    <td class="text-center"><input type="text" name='payment_number' value='{{ $payment_number }}' class="form-control" readonly required/></td>
...
@section('javascript')
    ...
    <script>
        ...
        var selectSeaFreightFreight = document.getElementById("transaction_number_id");
        selectSeaFreightFreight.onchange = function() { nameTextField.value = selectSeaFreightFreight.selectedOptions[0].innerText };

        var nameTextField = document.getElementById("expense_category");
    </script>
