...
@section('content')
    ...
    {!! Form::model($salaries_request_total, ['method' => 'PUT', 'route' => ['admin.salaries_request_totals.update', $salaries_request_total->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-2 form-group">
                    ...
                    {!! Form::text('batch_number', old('batch_number'), ['class' => 'form-control', 'placeholder' => 'Auto Generated', 'readonly']) !!}
