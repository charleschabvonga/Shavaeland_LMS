...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.payslips.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-2 form-group pull-right">
                    ...
                    <td class="text-center"><input type="text" name='payslip_number' value='{{ $payslip_number }}' class="form-control" readonly required/></td>
                            ...
                            <tr id='addr0'>
                                ...
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        <input type="text" name='qty1[]' placeholder='0' class="form-control qty1" step="0" min="0"/>
                                ...
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        ...
                                        <input type="text" name='unit_price1[]' placeholder='0.00' class="form-control price1" step="0.00" min="0"/>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        <div class="input-group-addon">R</div>
                                        <input type="text" name='total1[]' placeholder='0.00' class="form-control total1" readonly/>
                                    </div>
                                </td>
                        ...
                        <table class="table" id="tab_logic_overtime_bonus_total">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        <div class="input-group-addon">R</div>
                                        <input type="text" name='overtime_and_bonus_total' placeholder='0.00' class="form-control overtime_and_bonus_total" id="overtime_and_bonus_total" readonly/>
                                    </div>
                                </td>
                            </tr>                     
                            </tbody>
                    ...
                    <table class="table table-bordered table-striped" id="tab_logic_deduction">
                        ...
                        <tbody id="invoice-items">
                            <tr id='adds0'>
                                ...
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        <input type="text" name='qty2[]' placeholder='0' class="form-control qty2" step="0" min="0"/>
                                ...
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        <div class="input-group-addon">R</div>
                                        <input type="text" name='unit_price2[]' placeholder='0.00' class="form-control price2" step="0.00" min="0"/>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        <div class="input-group-addon">R</div>
                                        <input type="text" name='total2[]' placeholder='0.00' class="form-control total2" readonly/>
                                    </div>
                                </td>
                                <td class="text-center"><a href="#" class="remove btn btn-xs btn-danger">@lang('Delete')</a></td>
                            </tr>
                        ...
                        <table class="table" id="tab_logic_deduction_total">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        <div class="input-group-addon">R</div>
                                        <input type="text" name='deductions_total' placeholder='0.00' class="form-control deductions_total" id="deductions_total" readonly/>
                                    </div>
                                </td>
                            </tr>                     
                            </tbody>
                    ...
                    <table class="table" id="tab_logic_total">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="input-group mb-2 mb-sm-0">
                                    <div class="input-group-addon">R</div>
                                    <input type="text" name='gross' placeholder='0.00' class="form-control" id="gross" readonly/>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="input-group mb-2 mb-sm-0">
                                    <input type="text" name="income_tax", class="form-control" id="tax" placeholder="0" name="invoice[vat_percent]">
                                    <div class="input-group-addon">%</div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="input-group mb-2 mb-sm-0">
                                    <div class="input-group-addon">R</div>
                                    <input type="text" name='income_tax_amount' id="income_tax_amount" placeholder='0.00' class="form-control" readonly/>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="input-group mb-2 mb-sm-0">
                                    <div class="input-group-addon">R</div>
                                    <input type="text" name='net_income' id="net_income" placeholder='0.00' class="form-control" />
                                </div>
                            </td>
                        </tr>
                        <tr>
