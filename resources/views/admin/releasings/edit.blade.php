...
@section('content')
    ...
    {!! Form::model($releasing, ['method' => 'PUT', 'route' => ['admin.releasings.update', $releasing->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group pull-right">
                    ...
                    {!! Form::text('release_number', old('release_number'), ['class' => 'form-control', 'placeholder' => 'Auto Generated']) !!}
