...
@section('content')
    ...
    {!! Form::model($receiving, ['method' => 'PUT', 'route' => ['admin.receivings.update', $receiving->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-2 form-group">
                    ...
                    {!! Form::text('date', old('date'), ['class' => 'form-control datetime', 'placeholder' => 'YYYY-MM-DD']) !!}
                    @if($errors->has('date'))
                        <p class="help-block">
                            {{ $errors->first('date') }}
                        </p>
                ...
                <div class="col-xs-2 form-group pull-right">
                    ...
                    {!! Form::text('receipt_number', old('receipt_number'), ['class' => 'form-control', 'placeholder' => 'Auto Generated']) !!}
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody id="warehouse-items">
                                    @forelse(old('received_items', []) as $index => $data)
                            ...
                            <tr id='addr0'>
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        ...
                                        <input type="text" name='rate' value='{{ $receiving->rate}}' placeholder='0.00' class="form-control rate" step="0" min="0"/>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        <input type="text" name='days' value='{{ $receiving->days}}' placeholder='0' class="form-control day" step="0.00" min="0"/>
                                        <div class="input-group-addon">days</div>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        <input type="text" name='total_area_coverd' value='{{ $receiving->total_area_coverd}}' placeholder='0' class="form-control area" />
                                ...
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        <div class="input-group-addon">R</div>
                                        <input type="text" name='total_amount' value='{{ $receiving->total_amount}}' placeholder='0.00' class="form-control total" readonly/>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
