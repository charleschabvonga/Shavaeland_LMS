...
@section('content')
    ...
    {!! Form::model($sea_freight, ['method' => 'PUT', 'route' => ['admin.sea_freights.update', $sea_freight->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('shipper__or_agent[]', $shipper__or_agents, old('shipper__or_agent') ? old('shipper__or_agent') : $sea_freight->shipper__or_agent->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-shipper__or_agent' , 'required' => '']) !!}
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="load-descriptions">
                    ...
                    @empty
                        @foreach($sea_freight->load_descriptions as $item)
                            @include('admin.sea_freights.load_descriptions_row', [
                                'index' => 'id-' . $item->id,
                                'field' => $item
                            ])
