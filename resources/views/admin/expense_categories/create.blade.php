...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.expense_categories.store'], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group">
                    ...
                    <td class="text-center"><input type="text" name='credit_note_number' value='{{ $credit_note_number }}' class="form-control" readonly required/></td>
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('purchase_order_number_id', trans('global.expense-category.fields.purchase-order-number').'', ['class' => 'control-label']) !!}
                    {!! Form::select('purchase_order_number_id', $purchase_order_numbers, old('purchase_order_number_id'), ['class' => 'form-control select2']) !!}
                    @if($errors->has('purchase_order_number_id'))
                        <p class="help-block">
                            {{ $errors->first('purchase_order_number_id') }}
                        </p>
                    @endif
                </div>
                <div class="col-xs-2 form-group">
                    {!! Form::label('vendor_purchase_order_number', trans('global.expense-category.fields.vendor-purchase-order-number').'', ['class' => 'control-label']) !!}
                    {!! Form::text('vendor_purchase_order_number', old('vendor_purchase_order_number'), ['class' => 'form-control', 'placeholder' => 'Vendor purchase order No.']) !!}
                    @if($errors->has('vendor_purchase_order_number'))
                        <p class="help-block">
                            {{ $errors->first('vendor_purchase_order_number') }}
                        </p>
                    @endif
                </div>
                <div class="col-xs-2 form-group">
                    {!! Form::label('status', trans('global.expense-category.fields.status').'', ['class' => 'control-label']) !!}
                    {!! Form::select('status', $enum_status, old('status'), ['class' => 'form-control select2', 'disabled' => 'true']) !!}
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-striped" id="tab_logic">
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#quotation_number_items" aria-controls="quotation_number_items" role="tab" data-toggle="tab">Credit note items</a></li>
                        </ul>
                        <thead>
                        <tr>
