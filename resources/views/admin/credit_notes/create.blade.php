...
@section('content')
    {!! Form::open(['method' => 'POST', 'route' => ['admin.credit_notes.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group">
                    ...
                    {!! Form::select('invoice_payment_number_id', $invoice_payment_numbers, old('invoice_payment_number_id'), ['class' => 'form-control select2 invoice_payment_number_id']) !!}
                ...
                <div class="col-xs-2 form-group">
                    ...
                    {!! Form::select('project_number_id', $project_numbers, old('project_number_id'), ['class' => 'form-control select2 project_number_id']) !!}
                ...
                <div class="col-xs-2 form-group">
                    ...
                    {!! Form::select('bank_reference_id', $bank_references, old('bank_reference_id'), ['class' => 'form-control select2 bank_reference_id']) !!}
...
@section('javascript')
    ...
    <script>
        $(document).ready(function(){
            $('.invoice_payment_number_id').prop('disabled', true);
            $('.project_number_id').prop('disabled', true);
            $('.invoice_number_id').prop('disabled', true);

            $('.refund_type').change(function(){
                var selectedOption = $('.refund_type option:selected');
                if(selectedOption.val() === 'Advance pymt refund'){
                    $('.invoice_payment_number_id').prop('disabled', true);
                    $('.project_number_id').prop('disabled', true);
                    $('.invoice_number_id').prop('disabled', true);
                    $('.bank_reference_id').prop('disabled', false);
                }

                if(selectedOption.val() === 'Sales refund cashback'){
                    $('.invoice_payment_number_id').prop('disabled', true);
                    $('.project_number_id').prop('disabled', false);
                    $('.invoice_number_id').prop('disabled', false);
                    $('.bank_reference_id').prop('disabled', true);
                }

                if(selectedOption.val() === 'Sales refund account credit'){
                    $('.invoice_payment_number_id').prop('disabled', true);
                    $('.project_number_id').prop('disabled', false);
                    $('.invoice_number_id').prop('disabled', false);
                    $('.bank_reference_id').prop('disabled', true);
