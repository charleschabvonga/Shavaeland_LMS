...
@section('content')
    ...
    {!! Form::model($air_freight, ['method' => 'PUT', 'route' => ['admin.air_freights.update', $air_freight->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('airline_or_agent[]', $airline_or_agents, old('airline_or_agent') ? old('airline_or_agent') : $air_freight->airline_or_agent->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-airline_or_agent' , 'required' => '']) !!}
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="load-descriptions">
                    ...
                    @empty
                        @foreach($air_freight->load_descriptions as $item)
                            @include('admin.air_freights.load_descriptions_row', [
                                'index' => 'id-' . $item->id,
                                'field' => $item
                            ])
