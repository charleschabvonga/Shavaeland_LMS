...
@section('content')
    <h3 class="page-title">@lang('global.drug-tests.title')</h3>
    
    {!! Form::model($drug_test, ['method' => 'PUT', 'route' => ['admin.drug_tests.update', $drug_test->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-2 form-group pull-right">
                    ...
                    {!! Form::text('drug_test_number', old('drug_test_number'), ['class' => 'form-control', 'placeholder' => 'Auto Generated']) !!}
