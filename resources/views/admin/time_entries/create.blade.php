        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group pull-right">
                    ...
                    <td class="text-center"><input type="text" name='operation_number' value='{{ $operation_number }}' class="form-control" required readonly/></td>
            ...
            <div class="row">
                <div class="col-xs-3 form-group">
                    ...
                    {!! Form::select('work_type[]', $work_types, old('work_type'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-work_type' ]) !!}
                ...
                <div class="col-xs-2 form-group">
                    ...
                    {!! Form::text('end_time', old('end_time'), ['class' => 'form-control datetime', 'placeholder' => 'YYYY-MM-DD HH:MM:SS', 'readonly']) !!}
