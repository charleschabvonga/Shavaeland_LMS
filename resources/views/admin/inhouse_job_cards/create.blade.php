...
@section('content')
    {!! Form::open(['method' => 'POST', 'route' => ['admin.inhouse_job_cards.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
             ...
             <div class="row">
                ...
                <div class="col-xs-2 form-group pull-right">
                    {!! Form::label('status', trans('global.inhouse-job-cards.fields.status').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                ...
                <div class="col-xs-3 form-group">
                    {!! Form::label('workshop_manager_id', trans('global.inhouse-job-cards.fields.workshop-manager').'', ['class' => 'control-label']) !!}
