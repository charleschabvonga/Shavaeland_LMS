<tr data-index="{{ $index }}">
    <td>{!! Form::text('job_card_items['.$index.'][workshop]', old('job_card_items['.$index.'][workshop]', isset($field) ? $field->workshop: ''), ['class' => 'form-control']) !!}</td>
...
<td>{!! Form::text('job_card_items['.$index.'][unit]', old('job_card_items['.$index.'][unit]', isset($field) ? $field->unit: ''), ['class' => 'form-control']) !!}</td>
