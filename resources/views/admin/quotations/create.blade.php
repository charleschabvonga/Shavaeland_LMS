        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group">
                    ...
                    <td class="text-center"><input type="text" name='quotation_number' value='{{ $quotation_number }}' class="form-control" readonly required/></td>
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group pull-right">
                    ...
                    {!! Form::select('status', $enum_status, old('status'), ['class' => 'form-control select2', 'required' => '', 'disabled' => true]) !!}
...
@section('javascript')
    ...
    <script type="text/html" id="item-descriptions-template">
        @include('admin.quotations.invoice_items_row',
                [
                    'index' => '_INDEX_',
                ])
               </script > 
