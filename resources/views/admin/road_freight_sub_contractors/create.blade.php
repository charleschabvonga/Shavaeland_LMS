...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.road_freight_sub_contractors.store'], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-2 form-group pull-right">
                    ...
                    <td class="text-center"><input type="text" name='subcontractor_number' value='{{ $subcontractor_number }}' class="form-control" readonly required/></td>
