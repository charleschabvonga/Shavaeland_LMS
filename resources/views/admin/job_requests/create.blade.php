...
@section('content')
    {!! Form::open(['method' => 'POST', 'route' => ['admin.job_requests.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group pull-right">
                    ...
                    <td class="text-center"><input type="text" name='job_request_number' value='{{ $job_request_number }}' class="form-control" readonly required/></td>
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group pull-right">
                    ...
                    <td class="text-center"><input type="text" name='requested_by' value='{{ Auth::user()->name }}' class="form-control" readonly/></td>
