...
@section('content')
    ...
    {!! Form::model($client_contact, ['method' => 'PUT', 'route' => ['admin.client_contacts.update', $client_contact->id]]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('company_name_id', trans('global.client-contacts.fields.company-name').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('contact_name', trans('global.client-contacts.fields.contact-name').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('phone_number', trans('global.client-contacts.fields.phone-number').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('email', trans('global.client-contacts.fields.email').'', ['class' => 'control-label']) !!}
