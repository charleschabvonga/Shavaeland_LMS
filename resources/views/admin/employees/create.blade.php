        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-4 form-group">
                    ...
                    {!! Form::select('department[]', $departments, old('department'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-department' ]) !!}
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-striped" id="tab_logic">
                        ...
                        <tbody id="emergency-contacts">
                            @foreach(old('emergency_contacts', []) as $index => $data)
                    ...
                    <table class="table table-bordered table-striped" id="tab_logic">
                        ...
                        <thead>
                            ...
                            <tbody id="beneficiary-details">
                                @foreach(old('beneficiary_details', []) as $index => $data)
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-striped" id="tab_logic">
                        ...
                        <tbody id="qualifications">
                            @foreach(old('qualifications', []) as $index => $data)
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-striped" id="tab_logic">
                        ...
                        <tbody id="identifications">
                            @foreach(old('identifications', []) as $index => $data)
