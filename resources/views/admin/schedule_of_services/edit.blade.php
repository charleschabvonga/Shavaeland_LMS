...
@section('content')
    ...
    {!! Form::model($schedule_of_service, ['method' => 'PUT', 'route' => ['admin.schedule_of_services.update', $schedule_of_service->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group pull-right">
                    ...
                    {!! Form::text('schedule_number', old('schedule_number'), ['class' => 'form-control', 'placeholder' => 'Auto Generated', 'readonly']) !!}
