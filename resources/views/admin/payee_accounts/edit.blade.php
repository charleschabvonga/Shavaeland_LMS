...
@section('content')
    ...
    {!! Form::model($payee_account, ['method' => 'PUT', 'route' => ['admin.payee_accounts.update', $payee_account->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group">
                    ...
                    {!! Form::text('account_number', old('account_number'), ['class' => 'form-control', 'placeholder' => 'Account No.']) !!}
