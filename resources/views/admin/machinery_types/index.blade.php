...
@section('content')
    ...
    @can('machinery_type_create')
    <p>
        <a href="{{ route('admin.machinery_types.create') }}" class="btn btn-success">@lang('global.app_add_new')</a>
    ...
    <p>
        <ul class="list-inline">
            <li><a href="{{ route('admin.machinery_types.index') }}" style="{{ request('show_deleted') == 1 ? '' : 'font-weight: 700' }}">@lang('global.app_all')</a></li> |
            <li><a href="{{ route('admin.machinery_types.index') }}?show_deleted=1" style="{{ request('show_deleted') == 1 ? 'font-weight: 700' : '' }}">@lang('global.app_trash')</a></li>
        </ul>
    </p>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-bordered table-striped {{ count($machinery_types) > 0 ? 'datatable' : '' }} @can('machinery_type_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                <thead>
                    <tr>
...
@section('javascript') 
    <script>
        @can('machinery_type_delete')
            @if ( request('show_deleted') != 1 ) window.route_mass_crud_entries_destroy = '{{ route('admin.machinery_types.mass_destroy') }}'; @endif
        @endcan
