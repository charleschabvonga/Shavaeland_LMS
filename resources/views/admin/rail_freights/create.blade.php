...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.rail_freights.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('railline_or_agent[]', $railline_or_agents, old('railline_or_agent'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-railline_or_agent' , 'required' => '']) !!}
