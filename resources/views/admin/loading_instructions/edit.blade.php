...
@section('content')
    ...
    {!! Form::model($loading_instruction, ['method' => 'PUT', 'route' => ['admin.loading_instructions.update', $loading_instruction->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 form-group pull-right">
                    ...
                    {!! Form::text('loading_instruction_number', old('loading_instruction_number'), ['class' => 'form-control', 'placeholder' => 'Auto Generate', 'readonly']) !!}
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <legend class="text-center"><span style="color:#CE8F64">SHAVAELAND INFO</span></legend>
                                ...
                                <br><br>
                                <div class="col-xs-12">
                                    {!! Form::label('trailers', trans('global.loading-instruction.fields.trailers').'', ['class' => 'control-label']) !!}
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-striped" id="tab_logic">
                        ...
                        <tr>
                            ...
                            <th th width="15%">@lang('global.load-descriptions.fields.qty')</th>
                            <th th width="15%">@lang('global.load-descriptions.fields.weight-volume')</th>                               
                            <th th width="9%">Actions</th>
                        </tr>
                        </thead>
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-striped" id="tab_logic">
                        ...
                        <tbody id="loading-requirements">
                            @forelse(old('loading_requirements', []) as $index => $data)
