...
<li role="presentation" class="active"><a href="#income_expense_calculator" aria-controls="income_expense_calculator" role="tab" data-toggle="tab">Road freight estimations</a></li>
...
<div role="tabpanel" class="tab-pane active" id="income_expense_calculator">
...
{!! Form::open(array(
        ...
        @endif
            ...
            <a href="{{ route('admin.machinery_sizes.index') }}" class="btn btn-default">@lang('global.app_back_to_list')</a>
        </div>
    </div>
@stop
