...
@section('content')
    ...
    {!! Form::model($parts_acquired, ['method' => 'PUT', 'route' => ['admin.parts_acquireds.update', $parts_acquired->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-2 form-group pull-right">
                    ...
                    {!! Form::text('prepared_by', old('prepared_by'), ['class' => 'form-control prepared_by', 'placeholder' => '', 'required' => '', 'readonly']) !!}
                ...
                <div class="col-xs-2 form-group pull-right">
                    ...
                    {!! Form::text('order_number', old('order_number'), ['class' => 'form-control order_number', 'placeholder' => '', 'required' => '', 'readonly']) !!}
                            ...
                            <tr id='addr0'>
                                ...
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        <input type="text" name='qty' value='{{ $parts_acquired->qty }}' placeholder='0' class="form-control qty" step="0" min="0"/>
                                ...
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        ...
                                        <input type="text" name='unit_price' value='{{ $parts_acquired->unit_price}}' placeholder='0.00' class="form-control unit_price" step="0.00" min="0"/>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="input-group mb-2 mb-sm-0">
                                        <div class="input-group-addon">R</div>
                                        <input type="text" name='total' value='{{ $parts_acquired->total }}' placeholder='0.00' class="form-control total" readonly/>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
