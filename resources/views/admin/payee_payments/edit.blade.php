...
@section('content')
    ...
    {!! Form::model($payee_payment, ['method' => 'PUT', 'route' => ['admin.payee_payments.update', $payee_payment->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-2 form-group">
                    ...
                    {!! Form::text('payee_payment_number', old('payee_payment_number'), ['class' => 'form-control', 'placeholder' => 'Auto Generated', 'readonly']) !!}
