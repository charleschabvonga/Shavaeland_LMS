...
@section('content')
    ...
    {!! Form::model($light_vehicle, ['method' => 'PUT', 'route' => ['admin.light_vehicles.update', $light_vehicle->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                @if (config('invoices.logo_file') != '')
                    <div class="col-md-12 text-center">
                        ...
                        <h1><span style="color:#CE8F64">VEHICLE</span></h1>
                    </div>
                @endif
            </div>
            ...
            <div class="row">
                <div class="col-xs-2 form-group">
                    {!! Form::label('vehicle_type', trans('global.light-vehicles.fields.vehicle-type').'', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('vehicle_description', trans('global.light-vehicles.fields.vehicle-description').'*', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('make', trans('global.light-vehicles.fields.make').'', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('model', trans('global.light-vehicles.fields.model').'', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('purchase_date', trans('global.light-vehicles.fields.purchase-date').'', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('purchase_price', trans('global.light-vehicles.fields.purchase-price').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-2 form-group">
                    {!! Form::label('chasis_number', trans('global.light-vehicles.fields.chasis-number').'', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('engine_number', trans('global.light-vehicles.fields.engine-number').'', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('size_id', trans('global.light-vehicles.fields.size').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-2 form-group">
                    {!! Form::label('starting_mileage', trans('global.light-vehicles.fields.starting-mileage').'', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('next_service_mileage', trans('global.light-vehicles.fields.next-service-mileage').'', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('next_service_date', trans('global.light-vehicles.fields.next-service-date').'', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('service_status', trans('global.light-vehicles.fields.service-status').'', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('availability', trans('global.light-vehicles.fields.availability').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-2 form-group">
                    {!! Form::label('salvage_value', trans('global.light-vehicles.fields.salvage-value').'', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('investment', trans('global.light-vehicles.fields.investment').'', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('depreciation', trans('global.light-vehicles.fields.depreciation').'', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('maintenance', trans('global.light-vehicles.fields.maintenance').'', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-2 form-group">
                    {!! Form::label('tyre', trans('global.light-vehicles.fields.tyre').'', ['class' => 'control-label']) !!}
