...
class DepartmentsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $employees = \App\Employee::whereHas('department',
                    function ($query) use ($id) {
                        $query->where('id', $id);
                    })->get();$payee_accounts = \App\PayeeAccount::where('department_id', $id)->get();

        $department = Department::findOrFail($id);

        return view('admin.departments.show', compact('department', 'employees', 'payee_accounts'));
    }
