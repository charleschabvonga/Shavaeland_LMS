...
$factory->define(App\LoadingInstruction::class, function (Faker\Generator $faker) {
    return [
        ...
        "pick_up_company_name" => $faker->name,
        "pickup_date_time" => $faker->date("Y-m-d H:i:s", $max = 'now'),
